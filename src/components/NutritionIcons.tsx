...
// A plain water droplet -- used for hydration tracking (kept separate from
// FatIcon now that it's a detailed avocado shape).
export function WaterDropIcon({ size = 20, color }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
