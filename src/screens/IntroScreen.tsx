...
import { LogoGlyph } from '../components/FlameLogo';
...
// LogoGlyph renders at 1.4x its `size` prop tall (see FlameLogo.tsx's
// viewBox). Resting the icon at -half its height moves it up so its
// *bottom* edge lands on the screen's vertical middle, instead of its
// center.
const ICON_SIZE = 64;
const ICON_REST_Y = -(ICON_SIZE * 1.4) / 2;
const TEXT_GAP = 20;
